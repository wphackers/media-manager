...
/***/ "./src/components/media-link-format-type/style.scss":
/*!**********************************************************!*\
  !*** ./src/components/media-link-format-type/style.scss ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/components/media-player/style.scss":
/*!************************************************!*\
  !*** ./src/components/media-player/style.scss ***!
  \************************************************/
/*! no static exports found */
...
/***/ "./src/components/media-selector/style.scss":
/*!**************************************************!*\
  !*** ./src/components/media-selector/style.scss ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./src/block-editor/hooks/colors/index.js":
/*!************************************************!*\
  !*** ./src/block-editor/hooks/colors/index.js ***!
  \************************************************/
...
/* harmony import */ var _components_with_colors__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../components/with-colors */ "./src/components/with-colors/index.js");
...
var getMediaManagerColorSupport = function getMediaManagerColorSupport(settings) {
  return Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__["getBlockSupport"])(settings, 'media-manager/color');
};
var getMediaManagerCustomClassNameSupport = function getMediaManagerCustomClassNameSupport(settings) {
  return Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__["getBlockSupport"])(settings, 'media-manager/customClassName');
};

function addMediaManagerColorSaveProps(props, settings, attributes) {
  var mediaColor = getMediaManagerColorSupport(settings);

  if (!mediaColor) {
    return props;
  }

  var customClassName = getMediaManagerCustomClassNameSupport(settings);

  var newProps = _objectSpread(_objectSpread({}, props), {}, {
    style: props.style || {}
  });

  var mediaColorClassNames = [];

  for (var prop in mediaColor) {
    if (/^__/.test(prop)) {
      continue;
    }

    var colorClassName = Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__["getColorClassName"])(mediaColor[prop].style, attributes[mediaColor[prop].attributeName]);
    mediaColorClassNames.push(colorClassName);
    var attrName = mediaColor[prop].customAttributeName;
    var stylePropName = mediaColor[prop].style === 'background-color' ? 'backgroundColor' : 'color';
    newProps.style[stylePropName] = colorClassName ? undefined : attributes[attrName];
  }

  newProps.className = classnames__WEBPACK_IMPORTED_MODULE_1___default.a.apply(void 0, [props === null || props === void 0 ? void 0 : props.className].concat(mediaColorClassNames, [customClassName]));
  return newProps;
}
...
function addMediaManagerColorSupport(settings) {
  ...
  var supportStylePropsMap = {}; // Block attributes.
  ...
  for (var prop in mediaColor) {
    ...
    var attributeName = /\wColor$/.test(prop) ? prop : "".concat(prop, "Color");
    var upperCaseName = attributeName.charAt(0).toUpperCase() + attributeName.slice(1); // Populate mediaColor supports object.

    mediaColor[prop] = _objectSpread(_objectSpread({}, mediaColor[prop]), {}, {
      attributeName: attributeName,
      customAttributeName: "custom".concat(upperCaseName),
      setterAttributeName: "set".concat(upperCaseName),
  ...
  return _objectSpread(_objectSpread({}, settings), {}, {
    ...
    getEditWrapperProps: function getEditWrapperProps(attrs) {
      var props = {};
    ...
    edit: Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__["compose"])([Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__["withColors"])(supportStylePropsMap), Object(_components_with_colors__WEBPACK_IMPORTED_MODULE_6__["default"])(mediaColor)])(settings.edit)
  });
}

Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__["addFilter"])('blocks.registerBlockType', 'media-manager/register-media-player-buttons-blocks', addMediaManagerColorSupport);
Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__["addFilter"])('blocks.getSaveContent.extraProps', 'media-manager/add-media-player-buttons-save-props', addMediaManagerColorSaveProps);

/***/ }),

/***/ "./src/block-editor/hooks/connect/consumer.js":
/*!****************************************************!*\
  !*** ./src/block-editor/hooks/connect/consumer.js ***!
  \****************************************************/
...
/* harmony import */ var _components_hooks_use_media_source_id__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../components/hooks/use-media-source-id */ "./src/components/hooks/use-media-source-id.js");
/* harmony import */ var _components_hooks_use_media_store__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../components/hooks/use-media-store */ "./src/components/hooks/use-media-store/index.js");
...
var SUPPORT_NAME = 'media-manager/connect-consumer';
var withMediaConnect = Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_7__["createHigherOrderComponent"])(function (OriginalBlock) {
  return function (props) {
    var mediaSourceId = Object(_components_hooks_use_media_source_id__WEBPACK_IMPORTED_MODULE_9__["default"])(props);
    var mediaSource = Object(_components_hooks_use_media_store__WEBPACK_IMPORTED_MODULE_10__["default"])(mediaSourceId);
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__["BlockContextProvider"], {
      value: {
        mediaSourceId: mediaSourceId
      }
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(OriginalBlock, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_2___default()({}, props, {
      mediaContext: {
        mediaSourceId: mediaSourceId
      },
      mediaSource: mediaSource,
      className: classnames__WEBPACK_IMPORTED_MODULE_4___default()(props.className, {
...
function addMediaManagerConnectSupport(settings) {
  if (!Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_6__["getBlockSupport"])(settings, SUPPORT_NAME)) {
    return settings;
  }

  return _objectSpread(_objectSpread({}, settings), {}, {
    usesContext: [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(settings.usesContext), ['mediaSourceId']),
    edit: withMediaConnect(settings.edit)
  });
}

Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_5__["addFilter"])('blocks.registerBlockType', 'media-manager/register-media-player-connect-blocks', addMediaManagerConnectSupport);

/***/ }),

/***/ "./src/block-editor/hooks/connect/index.js":
/*!*************************************************!*\
  !*** ./src/block-editor/hooks/connect/index.js ***!
  \*************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _provider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./provider */ "./src/block-editor/hooks/connect/provider.js");
/* harmony import */ var _consumer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./consumer */ "./src/block-editor/hooks/connect/consumer.js");
/**
...
/***/ "./src/block-editor/hooks/connect/provider.js":
/*!****************************************************!*\
  !*** ./src/block-editor/hooks/connect/provider.js ***!
  \****************************************************/
/*! exports provided: SUPPORT_NAME, mediaProviderBlockAttributeName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _store_constants__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../store/constants */ "./src/store/constants.js");
/* harmony import */ var _components_media_selector__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../components/media-selector */ "./src/components/media-selector/index.js");
/* harmony import */ var _block_library_media_center__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../block-library/media-center */ "./src/block-library/media-center/index.js");
...
var SUPPORT_NAME = 'media-manager/connect-provider'; // In-sync constants.

var MEDIA_CURRENT_TIME_THRESHOLD = 1000;
var MEDIA_CURRENT_STATE_THRESHOLD = 1000;

var MediaEdit = function MediaEdit(providerProps) {
  return Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_7__["createHigherOrderComponent"])(function (BlockEdit) {
    return function (props) {
      var clientId = props.clientId;
      var mediaElementRef = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["useRef"])();
      var attributes = props.attributes,
          setAttributes = props.setAttributes;
      var mediaSourceIdAttr = attributes.mediaSourceId;
      var attrName = providerProps.name,
          domTypeName = providerProps.domTypeName; // Check media has defined its source.

      var mediaSourceUrl = attributes === null || attributes === void 0 ? void 0 : attributes[attrName]; // Media Source actions.

      var _useDispatch = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_6__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_10__["store"]),
      ...
      var _useDispatch2 = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_6__["useDispatch"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__["store"]),
          updateBlockAttributes = _useDispatch2.updateBlockAttributes; // Media Source selectors.
      ...
      var _useSelect = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_6__["useSelect"])(function (select) {
        return {
          mediaPlayingState: select(_store__WEBPACK_IMPORTED_MODULE_10__["store"]).getMediaPlayerState(mediaSourceIdAttr),
          currentTime: select(_store__WEBPACK_IMPORTED_MODULE_10__["store"]).getMediaSourceCurrentTime(mediaSourceIdAttr),
          mediaSource: select(_store__WEBPACK_IMPORTED_MODULE_10__["store"]).getMediaSourceById(mediaSourceIdAttr)
        };
      }, []),
          mediaPlayingState = _useSelect.mediaPlayingState,
          currentTime = _useSelect.currentTime,
          mediaSource = _useSelect.mediaSource;

      var mediaCenterParentBlock = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_6__["useSelect"])(function (select) {
        var _select$getBlockParen;

        return select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__["store"]).getBlock((_select$getBlockParen = select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__["store"]).getBlockParentsByBlockName(clientId, _block_library_media_center__WEBPACK_IMPORTED_MODULE_13__["blockName"])) === null || _select$getBlockParen === void 0 ? void 0 : _select$getBlockParen[0]);
      }, []);
      var mediaCenterParentClientId = mediaCenterParentBlock === null || mediaCenterParentBlock === void 0 ? void 0 : mediaCenterParentBlock.clientId;
      var mediaCenterParentSourceIdAttr = mediaCenterParentBlock === null || mediaCenterParentBlock === void 0 ? void 0 : mediaCenterParentBlock.attributes.mediaSourceId;
      ...
      function play() {
        ...
        (_mediaElementRef$curr = mediaElementRef.current) === null || _mediaElementRef$curr === void 0 ? void 0 : _mediaElementRef$curr.play().catch(function () {});
      }
      ...
      Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
        ...
        var mediaSourceId = mediaSourceIdAttr;

        if (!mediaSourceId) {
          mediaSourceId = "media-source-".concat(clientId); // update the block attribute.
        ...
        var querySelector = "[data-media-source-provider-id=\"".concat(mediaSourceId, "\"] ").concat(domTypeName);
        var mediaElement = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector(querySelector);
        ...
        registerMediaSource(mediaSourceId, {
          ...
          state: _store_constants__WEBPACK_IMPORTED_MODULE_11__["STATE_PAUSED"],
        ...
        return function () {
          ...
          if (mediaCenterParentSourceIdAttr === mediaSourceIdAttr) {
            updateBlockAttributes(mediaCenterParentClientId, {
              mediaSourceId: _store_constants__WEBPACK_IMPORTED_MODULE_11__["MEDIA_NOT_DEFINED"]
            });
          } // Remove listeners.
      ...
      Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
        ...
        if (mediaCenterParentSourceIdAttr && mediaCenterParentSourceIdAttr !== _store_constants__WEBPACK_IMPORTED_MODULE_11__["MEDIA_NOT_DEFINED"]) {
          return;
      ...
      Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
        ...
        var mediaElement = mediaElementRef.current;
        /*
         * Get the current status of the mediaElement element,
         * and the required action to toggle it.
         */

        var _ref = mediaElement.paused === false ? [_store_constants__WEBPACK_IMPORTED_MODULE_11__["STATE_PLAYING"], pause] : [_store_constants__WEBPACK_IMPORTED_MODULE_11__["STATE_PAUSED"], play],
            _ref2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_ref, 2),
            mediaElementStatus = _ref2[0],
            action = _ref2[1];

        var debouncedAction = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["debounce"])(action, 100);

        if (_store_constants__WEBPACK_IMPORTED_MODULE_11__["STATE_ERROR"] !== mediaPlayingState && mediaElementStatus !== mediaPlayingState) {
          debouncedAction();
        }
      ...
      }, [mediaPlayingState, mediaElementRef]); // Handling media state.
      ...
      Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
        ...
        var throttledTimeChange = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["throttle"])(function (time) {
      ...
      }, [mediaElementRef, currentTime]); // Bail early when no clientId.
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_components_media_selector__WEBPACK_IMPORTED_MODULE_12__["MediaCenterPanelBody"], {
        source: mediaSource
      }))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
        "data-media-source-provider-id": attributes === null || attributes === void 0 ? void 0 : attributes.mediaSourceId
...
var mediaProviderBlockAttributeName = 'mediaSourceId';

function addMediaManagerConnectSupport(settings, name) {
  var blockProviderProps = Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__["getBlockSupport"])(settings, SUPPORT_NAME);
  ...
  var attributes = _objectSpread(_objectSpread({}, settings.attributes), {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, mediaProviderBlockAttributeName, {
    type: 'string'
  }));
...
Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__["addFilter"])('blocks.registerBlockType', 'media-manager/register-media-player-connect-blocks', addMediaManagerConnectSupport, 20);

/***/ }),

/***/ "./src/block-editor/hooks/index.js":
/*!*****************************************!*\
  !*** ./src/block-editor/hooks/index.js ***!
  \*****************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _colors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./colors */ "./src/block-editor/hooks/colors/index.js");
/* harmony import */ var _connect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./connect */ "./src/block-editor/hooks/connect/index.js");
/* harmony import */ var _media_selector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./media-selector */ "./src/block-editor/hooks/media-selector/index.js");
...
/* harmony import */ var _sizes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sizes */ "./src/block-editor/hooks/sizes/index.js");
...
/* harmony import */ var _connect_provider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./connect/provider */ "./src/block-editor/hooks/connect/provider.js");
...
/* harmony import */ var _connect_consumer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./connect/consumer */ "./src/block-editor/hooks/connect/consumer.js");
...
/***/ "./src/block-editor/hooks/media-selector/index.js":
/*!********************************************************!*\
  !*** ./src/block-editor/hooks/media-selector/index.js ***!
  \********************************************************/
/*! exports provided: SUPPORT_NAME, withMediaSelector, mediaConsumerBlockAttributeName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _store_constants__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../store/constants */ "./src/store/constants.js");
/* harmony import */ var _components_media_selector___WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../components/media-selector/ */ "./src/components/media-selector/index.js");
/* harmony import */ var _components_hooks_use_media_source_id__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../components/hooks/use-media-source-id */ "./src/components/hooks/use-media-source-id.js");
...
var SUPPORT_NAME = 'media-manager/media-selector';

var useInsertMediaBlock = function useInsertMediaBlock() {
  var _useDispatch = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__["useDispatch"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_11__["store"]),
      insertBlock = _useDispatch.insertBlock;

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useCallback"])( /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default.a.mark(function _callee() {
    var blockType,
        clientId,
        index,
        mediaBlock,
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            blockType = _args.length > 0 && _args[0] !== undefined ? _args[0] : 'core/video';
            clientId = _args.length > 1 ? _args[1] : undefined;
            index = _args.length > 2 && _args[2] !== undefined ? _args[2] : 0;
            _context.next = 5;
            return Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_7__["createBlock"])(blockType);

          case 5:
            mediaBlock = _context.sent;
            _context.next = 8;
            return insertBlock(mediaBlock, index, clientId, false);
...
var withMediaSelector = Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_10__["createHigherOrderComponent"])(function (OriginalBlock) {
  return function (props) {
    var attributes = props.attributes,
        setAttributes = props.setAttributes,
    ...
    var mediaSourceReferenceId = attributes.mediaSourceReferenceId;

    var _useState = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useState"])(false),
        _useState2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_useState, 2),
        isReplacing = _useState2[0],
        setIsReplacing = _useState2[1];

    var mediaSourceId = Object(_components_hooks_use_media_source_id__WEBPACK_IMPORTED_MODULE_16__["default"])(props);

    var _useSelect = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__["useSelect"])(function (select) {
      return {
        mediaSources: select(_store__WEBPACK_IMPORTED_MODULE_13__["store"]).getMediaSources()
      };
    }, []),
        mediaSources = _useSelect.mediaSources;

    var _useSelect2 = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__["useSelect"])(function (select) {
      return {
        mediaSource: select(_store__WEBPACK_IMPORTED_MODULE_13__["store"]).getMediaSourceById(mediaSourceId)
      };
    }, [mediaSourceId]),
        mediaSource = _useSelect2.mediaSource;

    var setSourceReferenceId = function setSourceReferenceId(sourceId) {
      return setAttributes({
        mediaSourceReferenceId: sourceId
      });
    };

    var insertMediaBlock = useInsertMediaBlock();

    function insertEmptyMediaBlock(type) {
      setSourceReferenceId(_store_constants__WEBPACK_IMPORTED_MODULE_14__["MEDIA_NOT_DEFINED"]);
      setIsReplacing(false);
      insertMediaBlock(type, clientId);
    }

    var _ref2 = Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_7__["getBlockType"])(name) || {},
        label = _ref2.title,
        instructions = _ref2.description,
        icon = _ref2.icon;

    if (isReplacing || !mediaSourceId) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
        className: "media-selector-placeholder"
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Placeholder"], {
        icon: icon.src,
        label: label,
        instructions: instructions
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_components_media_selector___WEBPACK_IMPORTED_MODULE_15__["default"], {
        media: Object(lodash__WEBPACK_IMPORTED_MODULE_5__["values"])(mediaSources),
        onMediaSelect: function onMediaSelect(id) {
          setSourceReferenceId(id);
          setIsReplacing(false);
        }
      }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Button"], {
        isSecondary: true,
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Continue adding a video block', 'media-manager'),
        onClick: function onClick() {
          return insertEmptyMediaBlock('core/video');
        }
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Start with Video block', 'media-manager')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Button"], {
        isSecondary: true,
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Continue adding a audio block', 'media-manager'),
        onClick: function onClick() {
          return insertEmptyMediaBlock('core/audio');
        }
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Start with an Audio block', 'media-manager')), isReplacing && mediaSourceId !== _store_constants__WEBPACK_IMPORTED_MODULE_14__["MEDIA_NOT_DEFINED"] && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Button"], {
        isTertiary: true,
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Cancel replacing media source', 'media-manager'),
        onClick: function onClick() {
          return setIsReplacing(false);
        }
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Cancel replacement', 'media-manager')), (!isReplacing || mediaSourceId === _store_constants__WEBPACK_IMPORTED_MODULE_14__["MEDIA_NOT_DEFINED"]) && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Button"], {
        isTertiary: true,
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Continue without media source', 'media-manager'),
        onClick: function onClick() {
          setIsReplacing(false);
          setSourceReferenceId(_store_constants__WEBPACK_IMPORTED_MODULE_14__["MEDIA_NOT_DEFINED"]);
        }
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Skip', 'media-manager'))));
    }

    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["Fragment"], null, !(context !== null && context !== void 0 && context.mediaSourceId) && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_11__["BlockControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Toolbar"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Button"], {
      onClick: function onClick() {
        return setIsReplacing(true);
      }
    }, mediaSourceId !== _store_constants__WEBPACK_IMPORTED_MODULE_14__["MEDIA_NOT_DEFINED"] ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Replace', 'media-manager') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Link', 'media-manager')))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_11__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_components_media_selector___WEBPACK_IMPORTED_MODULE_15__["MediaItemPanelBody"], {
      source: mediaSource,
      mediaSourceId: mediaSourceId,
      isMediaInherited: !mediaSourceReferenceId,
      onReplace: setIsReplacing,
      onUnlink: function onUnlink() {
        return setSourceReferenceId(null);
      }
    }))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(OriginalBlock, props));
  };
}, 'withMediaSelector'); // Block attibute name used to poulate the consumers.

var mediaConsumerBlockAttributeName = 'mediaSourceReferenceId';

function addMediaSelectorSupport(settings) {
  if (!Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_7__["getBlockSupport"])(settings, SUPPORT_NAME)) {
    return settings;
  }

  return _objectSpread(_objectSpread({}, settings), {}, {
    attributes: _objectSpread(_objectSpread({}, settings.attributes), {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, mediaConsumerBlockAttributeName, {
      type: 'string'
    })),
...
Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_6__["addFilter"])('blocks.registerBlockType', 'media-manager/register-media-selector-blocks', addMediaSelectorSupport);

/***/ }),

/***/ "./src/block-editor/hooks/sizes/index.js":
/*!***********************************************!*\
  !*** ./src/block-editor/hooks/sizes/index.js ***!
  \***********************************************/
...
/* harmony import */ var _components_with_sizes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../components/with-sizes */ "./src/components/with-sizes/index.js");
...
var SUPPORT_NAME = 'media-manager/sizes';

function addMediaManagerSizeSaveProps(props, settings, attributes) {
  var sizes = Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_3__["getBlockSupport"])(settings, SUPPORT_NAME);
  ...
  return _objectSpread(_objectSpread({}, props), {}, {
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(props === null || props === void 0 ? void 0 : props.className, "is-".concat(size, "-size"))
  });
}
...
function addMediaManagerSizeSupport(settings) {
  ...
  return _objectSpread(_objectSpread({}, settings), {}, {
    ...
    edit: Object(_components_with_sizes__WEBPACK_IMPORTED_MODULE_4__["default"])(sizes)(settings.edit)
  });
}

Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__["addFilter"])('blocks.registerBlockType', 'media-manager/register-media-player-buttons-blocks', addMediaManagerSizeSupport, 0 // <- it change the order in the InspectorControls (sidebar)
);
Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__["addFilter"])('blocks.getSaveContent.extraProps', 'media-manager/add-media-player-buttons-save-props', addMediaManagerSizeSaveProps);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hooks */ "./src/block-editor/hooks/index.js");
/**
 * Internal dependencies
 */
...
var MEDIA_CENTER_TEMPLATE = [['core/paragraph', {
...
/* harmony import */ var _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../block-editor/hooks */ "./src/block-editor/hooks/index.js");
...
var blockName = 'media-manager/media-center';

Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__["registerBlockType"])(blockName, {
  apiVersion: 2,
  edit: _edit__WEBPACK_IMPORTED_MODULE_3__["default"],
  save: _save__WEBPACK_IMPORTED_MODULE_4__["default"],
  icon: _components_icons__WEBPACK_IMPORTED_MODULE_2__["MediaCenterIcon"],
  supports: (_supports = {
    align: true
  }, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__["SUPPORT_CONNECT_CONSUMER"], true), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__["SUPPORT_MEDIA_SELECTOR"], true), _supports)
});
...
var PLAYER_BLOCKS = [_play_button__WEBPACK_IMPORTED_MODULE_2__["blockName"], _pause_button__WEBPACK_IMPORTED_MODULE_3__["blockName"], _play_pause_button__WEBPACK_IMPORTED_MODULE_4__["blockName"], _time_position__WEBPACK_IMPORTED_MODULE_5__["blockName"]];
function MediaPlayerEditBlock() {
  var blockProps = Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["useBlockProps"])();
  var innerBlocksProps = Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["__experimentalUseInnerBlocksProps"])(blockProps, {
...
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/icons */ "./src/components/icons/index.js");
...
/* harmony import */ var _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../block-editor/hooks */ "./src/block-editor/hooks/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./style.scss */ "./src/block-library/media-player/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_7__);


var _supports, _buttonSupports;
...
var blockName = 'media-manager/media-player';
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__["registerBlockType"])(blockName, {
  apiVersion: 2,
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Media Player', 'media-manager'),
  description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Compose your custom media player with blocks', 'media-manager'),
  edit: _edit__WEBPACK_IMPORTED_MODULE_4__["default"],
  save: _save__WEBPACK_IMPORTED_MODULE_5__["default"],
  icon: _components_icons__WEBPACK_IMPORTED_MODULE_3__["PlayerIcon"],
  supports: (_supports = {
    align: true
  }, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__["SUPPORT_CONNECT_CONSUMER"], true), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__["SUPPORT_MEDIA_SELECTOR"], true), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, 'media-manager/color', {
    background: {
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Background color', 'media-manager'),
      style: 'background-color'
    }
  }), _supports)
}); // Common supports for player buttons blocks.

var buttonSupports = (_buttonSupports = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_buttonSupports, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__["SUPPORT_SIZES"], {
  __sectionTitle: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Button size', 'media-manager')
}), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_buttonSupports, "align", true), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_buttonSupports, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__["SUPPORT_CONNECT_CONSUMER"], true), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_buttonSupports, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__["SUPPORT_MEDIA_SELECTOR"], true), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_buttonSupports, 'media-manager/color', {
  icon: {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Icon color', 'media-manager'),
    style: 'background-color'
  },
  background: {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Background color', 'media-manager')
  ...
  __sectionTitle: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Color', 'media-manager')
}), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_buttonSupports, 'media-manager/customClassName', 'wp-media-manager-player-button'), _buttonSupports);
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_media_player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/media-player */ "./src/components/media-player/index.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./src/block-library/pause-button/editor.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_editor_scss__WEBPACK_IMPORTED_MODULE_3__);
...
function PlayEditBlock(_ref) {
  var mediaSource = _ref.mediaSource,
      scale = _ref.scale,
      className = _ref.className;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["useBlockProps"])(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_media_player__WEBPACK_IMPORTED_MODULE_2__["PauseButton"], {
    className: className,
...
var blockName = 'media-manager/pause-button';
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_2___default()(function () {
  ...
  Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])(blockName, {
    ...
    icon: _components_icons__WEBPACK_IMPORTED_MODULE_3__["PlayerPauseIcon"],
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/icons */ "./src/components/icons/index.js");
/* harmony import */ var _components_with_sizes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/with-sizes */ "./src/components/with-sizes/index.js");
...
function save(_ref) {
  ...
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_icons__WEBPACK_IMPORTED_MODULE_2__["PlayerPauseIcon"], {
    scale: Object(_components_with_sizes__WEBPACK_IMPORTED_MODULE_3__["getButtonSizeBySlug"])(attributes === null || attributes === void 0 ? void 0 : attributes.size)
  })));
}
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_media_player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/media-player */ "./src/components/media-player/index.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./src/block-library/play-button/editor.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_editor_scss__WEBPACK_IMPORTED_MODULE_3__);
...
function PlayEditBlock(_ref) {
  var mediaSource = _ref.mediaSource,
      scale = _ref.scale,
      className = _ref.className;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["useBlockProps"])(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_media_player__WEBPACK_IMPORTED_MODULE_2__["PlayButton"], {
    className: className,
    isPaused: mediaSource.isPaused,
    scale: scale,
...
var blockName = 'media-manager/play-button';
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_2___default()(function () {
  // we need this if we'd like to extend the block :'(
  Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])(blockName, {
    apiVersion: 2,
    ...
    edit: _edit__WEBPACK_IMPORTED_MODULE_5__["default"],
    save: _save__WEBPACK_IMPORTED_MODULE_6__["default"],
    icon: _components_icons__WEBPACK_IMPORTED_MODULE_3__["PlayerPlayIcon"],
    supports: _media_player__WEBPACK_IMPORTED_MODULE_4__["buttonSupports"]
  });
});
...
function save(_ref) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["useBlockProps"].save(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("button", {
    className: "wp-media-manager-player-button__button"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_icons__WEBPACK_IMPORTED_MODULE_2__["PlayerPlayIcon"], {
    scale: Object(_components_with_sizes__WEBPACK_IMPORTED_MODULE_3__["getButtonSizeBySlug"])(attributes === null || attributes === void 0 ? void 0 : attributes.size)
  })));
}
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_media_player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/media-player */ "./src/components/media-player/index.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./src/block-library/play-pause-button/editor.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_editor_scss__WEBPACK_IMPORTED_MODULE_3__);
...
function PlayPauseEditBlock(_ref) {
  var mediaSource = _ref.mediaSource,
      scale = _ref.scale,
      className = _ref.className;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["useBlockProps"])(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_media_player__WEBPACK_IMPORTED_MODULE_2__["PlayPauseButton"], {
    className: className,
    isPaused: mediaSource.isPaused,
    scale: scale,
...
var blockName = 'media-manager/play-pause-button';
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_2___default()(function () {
  // we need this if we'd like to extend the block :'(
  Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])(blockName, {
    apiVersion: 2,
    ...
    edit: _edit__WEBPACK_IMPORTED_MODULE_5__["default"],
    save: _save__WEBPACK_IMPORTED_MODULE_6__["default"],
    icon: _components_icons__WEBPACK_IMPORTED_MODULE_3__["PlayerPlayPauseIcon"],
    supports: _media_player__WEBPACK_IMPORTED_MODULE_4__["buttonSupports"]
  });
});
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_with_sizes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/with-sizes */ "./src/components/with-sizes/index.js");
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/icons */ "./src/components/icons/index.js");
...
function save(_ref) {
  var attributes = _ref.attributes;
  var scale = Object(_components_with_sizes__WEBPACK_IMPORTED_MODULE_2__["getButtonSizeBySlug"])(attributes === null || attributes === void 0 ? void 0 : attributes.size);
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["useBlockProps"].save(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("button", {
    className: "wp-media-manager-player-button__button is-media-paused"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_icons__WEBPACK_IMPORTED_MODULE_3__["PlayerPlayPauseIcon"], {
    scale: scale
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_icons__WEBPACK_IMPORTED_MODULE_3__["PlayerPauseIcon"], {
    scale: scale
  })));
}
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_hooks_use_current_time__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/hooks/use-current-time */ "./src/components/hooks/use-current-time/index.js");
...
function TimePositionDisplayEditBlock(_ref) {
  ...
  var _useCurrentTime = Object(_components_hooks_use_current_time__WEBPACK_IMPORTED_MODULE_2__["default"])(mediaSourceId),
...
/* harmony import */ var _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../block-editor/hooks */ "./src/block-editor/hooks/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./style.scss */ "./src/block-library/time-position/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_7__);
...
var blockName = 'media-manager/time-position-display';
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__["registerBlockType"])(blockName, {
  apiVersion: 2,
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Time position display', 'media-manager'),
  description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Block show the current time position of the media source', 'media-manager'),
  edit: _edit__WEBPACK_IMPORTED_MODULE_4__["default"],
  save: _save__WEBPACK_IMPORTED_MODULE_5__["default"],
  icon: _components_icons__WEBPACK_IMPORTED_MODULE_3__["TimePositionIcon"],
  supports: (_supports = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__["SUPPORT_CONNECT_CONSUMER"], true), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_6__["SUPPORT_MEDIA_SELECTOR"], true), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, "align", true), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, "typography", {
    fontSize: true,
    lineHeight: true,
    __experimentalFontStyle: true,
    __experimentalFontWeight: true,
    __experimentalFontFamily: true
  }), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, 'media-manager/color', {
    text: {
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Text color', 'media-manager')
    },
    __sectionTitle: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Color', 'media-manager')
  }), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_supports, 'media-manager/customClassName', 'wp-media-manager-player-button'), _supports)
});
...
/***/ "./src/components/hooks/use-media-source-id.js":
/*!*****************************************************!*\
  !*** ./src/components/hooks/use-media-source-id.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/* harmony import */ var _block_editor_hooks_media_selector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../block-editor/hooks/media-selector */ "./src/block-editor/hooks/media-selector/index.js");
/**
 * Internal dependencies
 */
...
function useMediaSourceId(props) {
  var attributes = props.attributes,
      context = props.context; // Pick up media source ID from attributes.

  if (attributes !== null && attributes !== void 0 && attributes[_block_editor_hooks_media_selector__WEBPACK_IMPORTED_MODULE_0__["mediaConsumerBlockAttributeName"]]) {
    return attributes[_block_editor_hooks_media_selector__WEBPACK_IMPORTED_MODULE_0__["mediaConsumerBlockAttributeName"]];
...
/***/ "./src/components/media-link-format-type/index.js":
/*!********************************************************!*\
  !*** ./src/components/media-link-format-type/index.js ***!
  \********************************************************/
/*! exports provided: MEDIA_LINK_FORMAT_TYPE, mediaLinkFormatButtonAttrs, mediaLinkFormatButtonSettings */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MEDIA_LINK_FORMAT_TYPE", function() { return MEDIA_LINK_FORMAT_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mediaLinkFormatButtonAttrs", function() { return mediaLinkFormatButtonAttrs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mediaLinkFormatButtonSettings", function() { return mediaLinkFormatButtonSettings; });
...
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../icons */ "./src/components/icons/index.js");
/* harmony import */ var _extending_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../extending/utils */ "./src/extending/utils.js");
/* harmony import */ var _media_link_popover__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./media-link-popover */ "./src/components/media-link-format-type/media-link-popover.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./style.scss */ "./src/components/media-link-format-type/style.scss");
...
/* harmony import */ var _lib_utils_time__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../lib/utils/time */ "./src/lib/utils/time.js");
/* harmony import */ var _input_rule_handler__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./input-rule-handler */ "./src/components/media-link-format-type/input-rule-handler.js");
...
var MEDIA_LINK_FORMAT_TYPE = 'media-manager/media-link-format-type';

function MediaLinkFormatButton(_ref) {
  var value = _ref.value,
      onChange = _ref.onChange,
      isActive = _ref.isActive,
      contentRef = _ref.contentRef;
  var mediatCenterBlockClientId = Object(_extending_utils__WEBPACK_IMPORTED_MODULE_8__["shouldExtendBlockWithMedia"])();
  var mediaCenterBlock = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_5__["useSelect"])(function (select) {
    return select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["store"]).getBlock(mediatCenterBlockClientId[0]);
  }, []);

  var _ref2 = (mediaCenterBlock === null || mediaCenterBlock === void 0 ? void 0 : mediaCenterBlock.attributes) || {},
      mediaSourceReferenceId = _ref2.mediaSourceReferenceId;

  var _useSelect = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_5__["useSelect"])(function (select) {
    return {
      domRef: select(_store__WEBPACK_IMPORTED_MODULE_6__["store"]).getMediaSourceDomReference(mediaSourceReferenceId)
    };
  }, []),
      domRef = _useSelect.domRef;

  var _useState = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useState"])(false),
      _useState2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState, 2),
      isMultipleEdition = _useState2[0],
      setIsMultipleEdition = _useState2[1];
  ...
  var _ref3 = Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_3__["getActiveFormat"])(value, MEDIA_LINK_FORMAT_TYPE) || {},
      attributes = _ref3.attributes;

  var ownerDocument = contentRef.current.ownerDocument;
  var defaultView = ownerDocument.defaultView; // Set the initial time position for the format:
  // (1) From extended `timestamp` block attr.
  // (2) Selected text when it has time format.
  // (3) Current position of the media source

  var mediaLinkFormatTimestamp = 0;
  var isSingleOnTheFlyStyle = false; // <- detects a single timeformat selected hh:mm:ss
  ...
  } else if (!Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_3__["isCollapsed"])(value)) {
    if (Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_11__["isTimeformat"])(selectedText)) {
      isSingleOnTheFlyStyle = true;
      mediaLinkFormatTimestamp = Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_11__["convertTimeCodeToSeconds"])(selectedText);
    }
  } else if (domRef !== null && domRef !== void 0 && domRef.currentTime) {
    mediaLinkFormatTimestamp = domRef.currentTime;
  }

  var multipleFormats = Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_11__["hasMultipleTimeformats"])(selectedText);
  /**
  ...
  function getStyleObject(time) {
    return {
      ...
      attributes: {
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Playback at %1$s'), Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_11__["convertSecondsToTimeCode"])(time))
      }
    };
  }
  /**
  ...
  function applyFormatStyleHandler(newTimestamp) {
    if (newTimestamp) {
      return onChange(Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_3__["applyFormat"])(value, getStyleObject(newTimestamp)));
    }

    onChange(Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_3__["toggleFormat"])(value, getStyleObject(mediaLinkFormatTimestamp)));
  }
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["RichTextToolbarButton"], {
    ...
    icon: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_icons__WEBPACK_IMPORTED_MODULE_7__["MediaLinkIcon"], null),
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Link to media', 'media-manager'),
    onClick: function onClick() {
      /*
    ...
    isActive: isActive
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_media_link_popover__WEBPACK_IMPORTED_MODULE_9__["default"], {
    value: value,
    ...
    onApplyMultipleFormat: function onApplyMultipleFormat() {
      var match;

      while ((match = Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_11__["getTimeformatMatch"])(selectedText)) != null) {
        var timestamp = match[0];
        var _match = match,
            startIndex = _match.index;
        var endIndex = startIndex + timestamp.length;
        value = Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_3__["applyFormat"])(value, {
          type: MEDIA_LINK_FORMAT_TYPE,
          attributes: {
            timestamp: "#".concat(Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_11__["convertTimeCodeToSeconds"])(timestamp)),
            label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Playback at %1$s'), timestamp)
          }
        }, startIndex, endIndex);
      }
...
var mediaLinkFormatButtonAttrs = {
  timestamp: 'href',
  label: 'title'
};
var mediaLinkFormatButtonSettings = {
  ...
  __unstableInputRule: _input_rule_handler__WEBPACK_IMPORTED_MODULE_12__["default"]
};
Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_3__["registerFormatType"])(MEDIA_LINK_FORMAT_TYPE, mediaLinkFormatButtonSettings);

/***/ }),

/***/ "./src/components/media-link-format-type/input-rule-handler.js":
/*!*********************************************************************!*\
  !*** ./src/components/media-link-format-type/input-rule-handler.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _lib_utils_time__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../lib/utils/time */ "./src/lib/utils/time.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ */ "./src/components/media-link-format-type/index.js");
/* harmony import */ var _block_library_media_center__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../block-library/media-center */ "./src/block-library/media-center/index.js");
/**
 * External dependencies
 */
...
/* harmony default export */ __webpack_exports__["default"] = (function (value) {
  ...
  var _select = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__["select"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__["store"]),
      getSelectedBlockClientId = _select.getSelectedBlockClientId,
      getBlockParentsByBlockName = _select.getBlockParentsByBlockName;

  var isChildOfMediaCenter = getBlockParentsByBlockName(getSelectedBlockClientId(), _block_library_media_center__WEBPACK_IMPORTED_MODULE_6__["blockName"]).length;

  if (!isChildOfMediaCenter) {
    return value;
  }

  var SIMPLE_OPEN_TRIGGER_CHAR = '[';
  var SIMPLE_CLOSE_TRIGGER_CHAR = ']';
  var MD_OPEN_TRIGGER_CHAR = '(';
  var MD_CLOSE_TRIGGER_CHAR = ')';
  var _value = value,
      start = _value.start,
      text = _value.text;
  var characterBefore = text.slice(start - 1, start);
  var trigger = text.slice(start - 2, start - 1);
  var isTriggerChar = trigger === SIMPLE_CLOSE_TRIGGER_CHAR || trigger === MD_CLOSE_TRIGGER_CHAR;
  ...
  if (characterBefore !== MD_OPEN_TRIGGER_CHAR) {
    var startIndex = textBefore.lastIndexOf(SIMPLE_OPEN_TRIGGER_CHAR);

    if (startIndex === -1) {
      return value;
    }

    var parts = Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_4__["isMarkfownTimeformat"])(textBefore);
    ...
    var endIndex = start - (parts !== null && parts !== void 0 && parts[2] ? timestamp.length + 5 : 3); // [hh:mm:ss].

    var charsToRemove = parts !== null && parts !== void 0 && parts[2] ? timestamp.length + 3 : 1; // // [hh:mm:ss](link).
    ...
    value = Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_0__["applyFormat"])(value, {
      type: ___WEBPACK_IMPORTED_MODULE_5__["MEDIA_LINK_FORMAT_TYPE"],
      attributes: {
        timestamp: "#".concat(Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_4__["convertTimeCodeToSeconds"])(timestamp)),
...
/***/ "./src/components/media-link-format-type/media-link-popover.js":
/*!*********************************************************************!*\
  !*** ./src/components/media-link-format-type/media-link-popover.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ */ "./src/components/media-link-format-type/index.js");
/* harmony import */ var _media_player__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../media-player */ "./src/components/media-player/index.js");
...
function MediaLinkPopover(_ref) {
  var value = _ref.value,
      hasMultipleTimeformats = _ref.hasMultipleTimeformats,
      isActive = _ref.isActive,
      isMultipleEdition = _ref.isMultipleEdition,
      contentRef = _ref.contentRef,
  ...
  var anchorRef = Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_2__["useAnchorRef"])({
    ref: contentRef,
    value: value,
    settings: ___WEBPACK_IMPORTED_MODULE_4__["mediaLinkFormatButtonSettings"]
  });
  var showMultipleEdition = isMultipleEdition && (hasMultipleTimeformats === null || hasMultipleTimeformats === void 0 ? void 0 : hasMultipleTimeformats.length) && !isActive;
...
/***/ "./src/components/media-player/index.js":
/*!**********************************************!*\
  !*** ./src/components/media-player/index.js ***!
  \**********************************************/
...
/* harmony import */ var _lib_utils_time__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../lib/utils/time */ "./src/lib/utils/time.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../store */ "./src/store/index.js");
/* harmony import */ var _store_constants__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../store/constants */ "./src/store/constants.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./style.scss */ "./src/components/media-player/style.scss");
...
function JumpBackButton(_ref) {
  var onClick = _ref.onClick,
      other = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2___default()(_ref, ["onClick"]);

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__["Button"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({
    icon: _icons__WEBPACK_IMPORTED_MODULE_8__["ControlBackFiveIcon"],
    onClick: onClick,
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Jump back', 'media-manager')
  }, other));
}
function PlayPauseButton(_ref2) {
  var onClick = _ref2.onClick,
      _ref2$isPaused = _ref2.isPaused,
      isPaused = _ref2$isPaused === void 0 ? false : _ref2$isPaused,
      scale = _ref2.scale,
      other = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2___default()(_ref2, ["onClick", "isPaused", "scale"]);

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__["Button"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({
    icon: isPaused ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_icons__WEBPACK_IMPORTED_MODULE_8__["PlayerPlayPauseIcon"], {
      scale: scale
    }) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_icons__WEBPACK_IMPORTED_MODULE_8__["PlayerPauseIcon"], {
      scale: scale
    }),
    disabled: false,
    onClick: onClick,
    label: isPaused ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Play', 'media-manager') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Pause', 'media-manager')
  }, other));
}
function PlayButton(_ref3) {
  var onClick = _ref3.onClick,
      _ref3$isPaused = _ref3.isPaused,
      isPaused = _ref3$isPaused === void 0 ? false : _ref3$isPaused,
      scale = _ref3.scale,
      other = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2___default()(_ref3, ["onClick", "isPaused", "scale"]);

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__["Button"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({
    icon: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_icons__WEBPACK_IMPORTED_MODULE_8__["PlayerPlayIcon"], {
      scale: scale
    }),
    onClick: onClick,
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Play', 'media-manager')
  }, other));
}
function PauseButton(_ref4) {
  var onClick = _ref4.onClick,
      _ref4$isPaused = _ref4.isPaused,
      isPaused = _ref4$isPaused === void 0 ? false : _ref4$isPaused,
      scale = _ref4.scale,
      other = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2___default()(_ref4, ["onClick", "isPaused", "scale"]);

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__["Button"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({
    icon: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_icons__WEBPACK_IMPORTED_MODULE_8__["PlayerPauseIcon"], {
      scale: scale
    }),
    onClick: onClick,
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Pause', 'media-manager')
  }, other));
}
function SkipForwardButton(_ref5) {
  var onClick = _ref5.onClick,
      other = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2___default()(_ref5, ["onClick"]);

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__["Button"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({
    icon: _icons__WEBPACK_IMPORTED_MODULE_8__["ControlForwardFiveIcon"],
    onClick: onClick,
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Skip forward', 'media-manager')
  }, other));
}
function MediaPlayerControl(_ref6) {
  var mediaSourceId = _ref6.mediaSourceId,
      time = _ref6.time,
      _ref6$onChange = _ref6.onChange,
      onChange = _ref6$onChange === void 0 ? function () {} : _ref6$onChange;

  var _useState = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useState"])(time),
      _useState2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState, 2),
      rangeTime = _useState2[0],
      setRangeTime = _useState2[1];

  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    return setRangeTime(time);
  }, [time]);

  var _useSelect = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_6__["useSelect"])(function (select) {
    return {
      mediaPlayingState: select(_store__WEBPACK_IMPORTED_MODULE_10__["store"]).getMediaPlayerState(mediaSourceId),
      mediaDuration: select(_store__WEBPACK_IMPORTED_MODULE_10__["store"]).getMediaSourceDuration(mediaSourceId),
      mediaSource: select(_store__WEBPACK_IMPORTED_MODULE_10__["store"]).getMediaSourceById(mediaSourceId)
    };
  }, [mediaSourceId]),
      mediaPlayingState = _useSelect.mediaPlayingState,
      mediaDuration = _useSelect.mediaDuration,
      mediaSource = _useSelect.mediaSource;
  ...
  var isPaused = mediaPlayingState === _store_constants__WEBPACK_IMPORTED_MODULE_11__["STATE_PAUSED"];
  var debouncedOnChange = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(Object(lodash__WEBPACK_IMPORTED_MODULE_4__["debounce"])(function (time, onChange) {
    if (!isPaused) {
  ...
  var currentTimeFormatted = Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_9__["convertSecondsToTimeCode"])(rangeTime);
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    className: "media-player-control"
  }, !mediaSource && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__["Notice"], {
    spokenMessage: null,
    status: "warning",
    isDismissible: false
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('No media linked to this block', 'context')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(JumpBackButton, {
    disabled: !mediaSource,
    onClick: function onClick() {
      return onChangeTimeHandler(Math.max(0, time - 5));
    }
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(PlayPauseButton, {
    isPaused: isPaused,
    disabled: !mediaSource,
    onClick: function onClick() {
      return toggleInTime();
    }
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(SkipForwardButton, {
    disabled: !mediaSource,
    onClick: function onClick() {
      return onChangeTimeHandler(Math.min(mediaDuration, time + 5));
    }
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    className: "media-player-control__display"
  }, currentTimeFormatted), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__["RangeControl"], {
...
/***/ "./src/components/media-selector/index.js":
/*!************************************************!*\
  !*** ./src/components/media-selector/index.js ***!
  \************************************************/
/*! exports provided: MediaItem, MediaItemPanelBody, MediaCenterPanelBody, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MediaCenterPanelBody", function() { return MediaCenterPanelBody; });
...
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./style.scss */ "./src/components/media-selector/style.scss");
...
/* harmony import */ var _lib_utils_time__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../lib/utils/time */ "./src/lib/utils/time.js");
/* harmony import */ var _media_player__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../media-player */ "./src/components/media-player/index.js");
/* harmony import */ var _store_constants__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../store/constants */ "./src/store/constants.js");
...
function MediaItem(_ref) {
  var type = _ref.elementType,
      source = _ref.source,
      id = _ref.id,
      showTypeLabel = _ref.showTypeLabel,
      _ref$onPlayToggle = _ref.onPlayToggle,
      onPlayToggle = _ref$onPlayToggle === void 0 ? function () {} : _ref$onPlayToggle,
  ...
  var itemReference = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useRef"])();
  ...
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(gridicons__WEBPACK_IMPORTED_MODULE_4___default.a, {
    className: "media__item-icon is-".concat(type),
    icon: type,
    size: 36
  }), showTypeLabel && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("strong", null, " ", type), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_media_player__WEBPACK_IMPORTED_MODULE_11__["PlayPauseButton"], {
...
function MediaItemPanelBody(_ref2) {
  var source = _ref2.source,
      mediaSourceId = _ref2.mediaSourceId,
      onReplace = _ref2.onReplace,
      onUnlink = _ref2.onUnlink,
      isMediaInherited = _ref2.isMediaInherited;
  var isMediaNotDefined = mediaSourceId === _store_constants__WEBPACK_IMPORTED_MODULE_12__["MEDIA_NOT_DEFINED"];

  var _useDispatch = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__["useDispatch"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__["store"]),
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelBody"], {
    ...
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Media Source', 'media-manager')
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Media source connected to the media center block', 'media-manager')), isMediaNotDefined && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["Notice"], {
    spokenMessage: null,
    status: "warning",
    isDismissible: false
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('No media linked to this block', 'context'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["Button"], {
    isSecondary: true,
    isSmall: true,
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Link to a media source', 'media-manager'),
    onClick: onReplace
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Link to Media', 'media-manager')))), source && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(MediaItem, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({}, source, {
    showTypeLabel: true,
    onPlayToggle: function onPlayToggle(element) {
      if (!element) {
        return;
      }
  ...
  }))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("ul", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("li", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Filename:', 'media-manager'), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("strong", null, " ", source.source)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("li", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Duration:', 'media-manager'), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("strong", null, ' ', Object(_lib_utils_time__WEBPACK_IMPORTED_MODULE_10__["convertSecondsToTimeCode"])(source.duration))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("li", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["sprintf"])(
  /* translators: %1$s: block title, %2$s: author name. */
  Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Connected to a %1$s.'), source.elementType), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["Button"], {
  ...
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Focus', 'media-manager'))))), !isMediaInherited && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    ...
    isSecondary: true,
    isSmall: true,
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Replacing linked media source', 'media-manager'),
    onClick: onReplace
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Replace Media', 'media-manager')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["Button"], {
    isTertiary: true,
    isSmall: true,
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Unlink media source', 'media-manager'),
    onClick: function onClick() {
      return onUnlink(true);
    }
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Unlink Media', 'media-manager'))))));
}
function MediaCenterPanelBody(_ref3) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelBody"], {
    className: "media-source-panel",
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Media Source', 'media-manager')
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Media Center connected to the media', 'media-manager')));
}
function MediaSelector(_ref4) {
  var media = _ref4.media,
      onMediaSelect = _ref4.onMediaSelect;
  ...
  var _useState3 = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useState"])(),
      ...
      mediaPlayingElementRef = _useState4[0],
      setMediaPlayingElementRef = _useState4[1];

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    className: "media-selector"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("h4", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Pick up a media from the media sources list available for this entrance.', 'media-manager')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("ul", null, media.map(function (_ref5) {
    var id = _ref5.id,
        other = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_0___default()(_ref5, ["id"]);

    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("li", {
      key: "item-".concat(id)
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(MediaItem, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({
      id: id
    }, other, {
...
/***/ "./src/components/with-colors/index.js":
/*!*********************************************!*\
  !*** ./src/components/with-colors/index.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function (supportProps) {
  return Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__["createHigherOrderComponent"])(function (BlockEdit) {
    return function (props) {
      // Panel title.
      var panelTitle = supportProps.__sectionTitle || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Color settings', 'media-manager'); // Panel color settings.


      var colorSettings = []; // Contrast checker.

      var contrastCheckerProps = {};

      for (var prop in supportProps) {
        ...
        var support = supportProps[prop];
        var value = (_props$support$attrib = props[support.attributeName]) === null || _props$support$attrib === void 0 ? void 0 : _props$support$attrib.color;
        colorSettings.push({
      ...
      }, supportProps.__contrastChecker && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__["ContrastChecker"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, contrastCheckerProps, {
        isLargeText: false
...
/***/ "./src/components/with-sizes/index.js":
/*!********************************************!*\
  !*** ./src/components/with-sizes/index.js ***!
  \********************************************/
/*! exports provided: getButtonSizeBySlug, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function getButtonSizeBySlug(slug) {
  ...
  return ((_defaultSizes$find = defaultSizes.find(function (option) {
    return option.slug === slug;
  })) === null || _defaultSizes$find === void 0 ? void 0 : _defaultSizes$find.size) || 1.5;
}
/* harmony default export */ __webpack_exports__["default"] = (function (supportProps) {
  return Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__["createHigherOrderComponent"])(function (BlockEdit) {
    return function (props) {
      var attributes = props.attributes,
          setAttributes = props.setAttributes;
      var size = attributes.size;
      var scale = getButtonSizeBySlug(size);

      function setSize(_ref) {
      ...
      var panelTitle = supportProps.__sectionTitle;

      var selectorTitle = supportProps.__selectorTitle || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Sizes', 'media-manager');
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["PanelBody"], {
        ...
        onChange: setSize,
        value: defaultSizes.find(function (option) {
          return option.slug === size;
        })
      })))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(BlockEdit, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
        scale: scale
      })));
    };
  }, 'withSizes');
...
/***/ "./src/extending/empowered-blocks-with-media.js":
/*!******************************************************!*\
  !*** ./src/extending/empowered-blocks-with-media.js ***!
  \******************************************************/
/*! no exports provided */
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils */ "./src/extending/utils.js");
/* harmony import */ var _components_media_link_format_type__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/media-link-format-type */ "./src/components/media-link-format-type/index.js");
...
var BlockEditWithMedia = function BlockEditWithMedia(name, BlockEdit) {
  return function (props) {
    var clientId = props.clientId;
    var isChildOfMediaCenter = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_3__["useSelect"])(function (select) {
      return !!select('core/block-editor').getBlockParentsByBlockName(clientId, 'media-manager/media-center').length;
    }, []);
...
function empowerBlocksWithMedia(settings, name) {
  if (!Object(_utils__WEBPACK_IMPORTED_MODULE_4__["shouldExtendBlockWithMedia"])(name)) {
    return settings;
  }
...
Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__["addFilter"])('blocks.registerBlockType', 'media-manager/empowerBlocksWithMedia', empowerBlocksWithMedia);
...
/* harmony import */ var _empowered_blocks_with_media__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./empowered-blocks-with-media */ "./src/extending/empowered-blocks-with-media.js");
/**
 * Internal dependencies
 */
...
/* harmony import */ var _block_editor_hooks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../block-editor/hooks */ "./src/block-editor/hooks/index.js");
...
function registerMediaBlocksSource(settings, name) {
  if (!Object(_utils__WEBPACK_IMPORTED_MODULE_2__["shouldExtendMediaBlock"])(name, settings)) {
    return settings;
  }

  return _objectSpread(_objectSpread({}, settings), {}, {
    supports: _objectSpread(_objectSpread({}, settings.support), {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, _block_editor_hooks__WEBPACK_IMPORTED_MODULE_3__["SUPPORT_CONNECT_PROVIDER"], Object(_utils__WEBPACK_IMPORTED_MODULE_2__["getBlockSourceProps"])(name)))
  });
}

Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__["addFilter"])('blocks.registerBlockType', 'media-manager/registerMediaBlockSource', registerMediaBlocksSource);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _extending__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./extending */ "./src/extending/index.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./src/store/index.js");
/* harmony import */ var _block_library__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block-library */ "./src/block-library/index.js");
/* harmony import */ var _block_editor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block-editor */ "./src/block-editor/index.js");
/**
 * External dependencies
 */
